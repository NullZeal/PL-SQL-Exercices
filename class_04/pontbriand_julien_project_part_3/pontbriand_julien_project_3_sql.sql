...
END;
/
-- 5000 MONTHLY SALARY, NO COMMISSION
exec giveEmpInfo (7839);
-- 1600 MONTHLY SALARY * 12 = 19200 + 300 COMMISSION = 19500
...
SELECT findAge('1-FEB-1992') FROM DUAL;
SELECT findAge('2-FEB-1992') FROM DUAL;
